...
export class LocaleListAdminComponent implements OnInit {

    protected fileName = 'Locale';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<LocaleDto>();
    ...
    public async edit(dto: LocaleDto) {
    ...
    public async view(dto: LocaleDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: LocaleDto) {
    ...
    public async duplicate(dto: LocaleDto) {
    ...
    public exportPdf(dto: LocaleDto): void {
...
// add
	...
	public initDuplicate(res: LocaleDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<LocaleDto> {
        return this.service.selections;
    }

    set selections(value: Array<LocaleDto>) {
