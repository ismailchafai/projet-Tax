...
export class QuartierListAdminComponent implements OnInit {

    protected fileName = 'Quartier';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<QuartierDto>();
    ...
    public async edit(dto: QuartierDto) {
    ...
    public async view(dto: QuartierDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: QuartierDto) {
    ...
    public async duplicate(dto: QuartierDto) {
    ...
    public exportPdf(dto: QuartierDto): void {
...
// add
	...
	public initDuplicate(res: QuartierDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<QuartierDto> {
        return this.service.selections;
    }

    set selections(value: Array<QuartierDto>) {
