...
export class RedevableListAdminComponent implements OnInit {

    protected fileName = 'Redevable';
    ...
    constructor( private service: RedevableAdminService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<RedevableDto>();
    ...
    public async edit(dto: RedevableDto) {
    ...
    public async view(dto: RedevableDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: RedevableDto) {
    ...
    public async duplicate(dto: RedevableDto) {
    ...
    public exportPdf(dto: RedevableDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get items(): Array<RedevableDto> {
        return this.service.items;
    }

    set items(value: Array<RedevableDto>) {
        this.service.items = value;
    }

    get selections(): Array<RedevableDto> {
        return this.service.selections;
    }

    set selections(value: Array<RedevableDto>) {
        this.service.selections = value;
    }

    get item(): RedevableDto {
        return this.service.item;
    }

    set item(value: RedevableDto) {
    ...
    get criteria(): RedevableCriteria {
        return this.service.criteria;
    }

    set criteria(value: RedevableCriteria) {
