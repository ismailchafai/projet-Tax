...
export class RueListAdminComponent implements OnInit {

    protected fileName = 'Rue';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<RueDto>();
    ...
    public async delete(dto: RueDto) {
    ...
    public async duplicate(dto: RueDto) {
    ...
    public exportPdf(dto: RueDto): void {
...
// add
	...
	public initDuplicate(res: RueDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<RueDto> {
        return this.service.selections;
    }

    set selections(value: Array<RueDto>) {
