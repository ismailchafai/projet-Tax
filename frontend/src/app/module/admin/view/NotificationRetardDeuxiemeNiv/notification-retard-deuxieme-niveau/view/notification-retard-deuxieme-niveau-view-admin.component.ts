...
export class NotificationRetardDeuxiemeNiveauViewAdminComponent implements OnInit {
    ...
    constructor(private service: NotificationRetardDeuxiemeNiveauAdminService, private localeService: LocaleAdminService, private redevableService: RedevableAdminService){
