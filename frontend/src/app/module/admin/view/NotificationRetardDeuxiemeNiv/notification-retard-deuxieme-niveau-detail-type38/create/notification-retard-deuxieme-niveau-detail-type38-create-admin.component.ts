...
@Component({
  selector: 'app-notification-retard-deuxieme-niveau-detail-type38-create-admin',
  templateUrl: './notification-retard-deuxieme-niveau-detail-type38-create-admin.component.html'
})
export class NotificationRetardDeuxiemeNiveauDetailType38CreateAdminComponent  implements OnInit {
