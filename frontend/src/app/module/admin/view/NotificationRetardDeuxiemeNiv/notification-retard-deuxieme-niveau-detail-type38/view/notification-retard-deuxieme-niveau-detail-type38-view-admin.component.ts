...
export class NotificationRetardDeuxiemeNiveauDetailType38ViewAdminComponent implements OnInit {
    ...
    constructor(private service: NotificationRetardDeuxiemeNiveauDetailType38AdminService, private typeLocale38DetailService: TypeLocale38DetailAdminService){
