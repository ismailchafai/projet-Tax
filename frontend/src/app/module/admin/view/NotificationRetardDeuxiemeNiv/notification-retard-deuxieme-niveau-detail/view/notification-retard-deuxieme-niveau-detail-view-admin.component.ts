...
export class NotificationRetardDeuxiemeNiveauDetailViewAdminComponent implements OnInit {
    ...
    constructor(private service: NotificationRetardDeuxiemeNiveauDetailAdminService, private trimService: TrimAdminService){
