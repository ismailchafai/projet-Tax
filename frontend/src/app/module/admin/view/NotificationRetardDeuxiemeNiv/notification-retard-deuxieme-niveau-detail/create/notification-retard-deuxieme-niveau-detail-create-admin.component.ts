...
@Component({
  selector: 'app-notification-retard-deuxieme-niveau-detail-create-admin',
  templateUrl: './notification-retard-deuxieme-niveau-detail-create-admin.component.html'
})
export class NotificationRetardDeuxiemeNiveauDetailCreateAdminComponent  implements OnInit {
