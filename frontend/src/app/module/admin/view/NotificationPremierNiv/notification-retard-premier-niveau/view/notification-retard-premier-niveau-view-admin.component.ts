...
export class NotificationRetardPremierNiveauViewAdminComponent implements OnInit {
    ...
    constructor(private service: NotificationRetardPremierNiveauAdminService, private localeService: LocaleAdminService, private redevableService: RedevableAdminService){
