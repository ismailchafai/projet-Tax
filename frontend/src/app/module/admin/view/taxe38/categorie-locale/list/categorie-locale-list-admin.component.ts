...
export class CategorieLocaleListAdminComponent implements OnInit {

    protected fileName = 'CategorieLocale';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CategorieLocaleDto>();
    ...
    public async edit(dto: CategorieLocaleDto) {
    ...
    public async view(dto: CategorieLocaleDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CategorieLocaleDto) {
    ...
    public async duplicate(dto: CategorieLocaleDto) {
    ...
    public exportPdf(dto: CategorieLocaleDto): void {
...
// add
	...
	public initDuplicate(res: CategorieLocaleDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<CategorieLocaleDto> {
        return this.service.selections;
    }

    set selections(value: Array<CategorieLocaleDto>) {
