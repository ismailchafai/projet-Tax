...
export class TauxTaxe38EditAdminComponent implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateMin = this.service.format(this.item.dateMin);
        this.item.dateMax = this.service.format(this.item.dateMax);
    }
