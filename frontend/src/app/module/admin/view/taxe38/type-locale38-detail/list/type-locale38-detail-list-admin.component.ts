...
export class TypeLocale38DetailListAdminComponent implements OnInit {

    protected fileName = 'TypeLocale38Detail';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TypeLocale38DetailDto>();
    ...
    public async edit(dto: TypeLocale38DetailDto) {
    ...
    public async view(dto: TypeLocale38DetailDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TypeLocale38DetailDto) {
    ...
    public async duplicate(dto: TypeLocale38DetailDto) {
    ...
    public exportPdf(dto: TypeLocale38DetailDto): void {
...
// add
	...
	public initDuplicate(res: TypeLocale38DetailDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<TypeLocale38DetailDto> {
        return this.service.selections;
    }

    set selections(value: Array<TypeLocale38DetailDto>) {
