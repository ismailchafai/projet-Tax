...
export class Locale38DetailListAdminComponent implements OnInit {

    protected fileName = 'Locale38Detail';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<Locale38DetailDto>();
    ...
    public async edit(dto: Locale38DetailDto) {
    ...
    public async view(dto: Locale38DetailDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: Locale38DetailDto) {
    ...
    public async duplicate(dto: Locale38DetailDto) {
    ...
    public exportPdf(dto: Locale38DetailDto): void {
...
// add
	...
	public initDuplicate(res: Locale38DetailDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<Locale38DetailDto> {
        return this.service.selections;
    }

    set selections(value: Array<Locale38DetailDto>) {
