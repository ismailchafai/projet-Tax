...
export class Locale38DetailViewAdminComponent implements OnInit {
    ...
    constructor(private service: Locale38DetailAdminService, private typeLocale38DetailService: TypeLocale38DetailAdminService){
