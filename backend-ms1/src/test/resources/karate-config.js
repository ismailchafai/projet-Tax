function fn() {
    ...
    config.adminUri = config.rootUrl + 'api/admin/';
        ...
        config.trimUrl = config.adminUri + 'trim/';
    config.categorieLocaleUrl = config.adminUri + 'categorieLocale/';
    config.typeLocale38DetailUrl = config.adminUri + 'typeLocale38Detail/';
    config.rueUrl = config.adminUri + 'rue/';
    config.villeUrl = config.adminUri + 'ville/';
    config.notificationRetardDeuxiemeNiveauUrl = config.adminUri + 'notificationRetardDeuxiemeNiveau/';
    config.locale38DetailUrl = config.adminUri + 'locale38Detail/';
    config.notificationRetardDeuxiemeNiveauDetailUrl = config.adminUri + 'notificationRetardDeuxiemeNiveauDetail/';
    config.secteurUrl = config.adminUri + 'secteur/';
    config.taxe38DetailUrl = config.adminUri + 'taxe38Detail/';
    config.notificationRetardPremierNiveauUrl = config.adminUri + 'notificationRetardPremierNiveau/';
    ...
    config.tauxTaxe38Url = config.adminUri + 'tauxTaxe38/';
    config.notificationRetardDeuxiemeNiveauDetailType38Url = config.adminUri + 'notificationRetardDeuxiemeNiveauDetailType38/';
    config.quartierUrl = config.adminUri + 'quartier/';
    config.notificationRetardTroisiemeNiveauUrl = config.adminUri + 'notificationRetardTroisiemeNiveau/';
