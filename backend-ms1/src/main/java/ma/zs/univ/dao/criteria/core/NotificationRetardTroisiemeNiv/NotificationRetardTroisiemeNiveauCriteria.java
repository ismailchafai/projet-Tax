package  ma.zs.univ.dao.criteria.core.NotificationRetardTroisiemeNiv;
...
public class NotificationRetardTroisiemeNiveauCriteria extends  BaseCriteria  {
    ...
    public NotificationRetardTroisiemeNiveauCriteria(){}
